...
const Footer = () => {
  return (
    <footer className="bg-finance-blue/90 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 mb-4">
              Transforming Excel portfolio data into actionable insights through beautiful visualizations.
            </p>
        ...
        <div className="border-t border-white/20 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-white/60 text-sm flex items-center mt-2 md:mt-0">
            Made with <Heart className="h-4 w-4 text-finance-teal mx-1 inline" /> by PortfolioVision Team
          </p>
        </div>
      </div>
    </footer>
